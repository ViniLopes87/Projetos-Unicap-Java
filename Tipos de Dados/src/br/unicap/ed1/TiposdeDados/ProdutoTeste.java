...
public class ProdutoTeste implements Objeto <ProdutoTeste> {
    private final String codigo;
    private String descricao;
    private double preco;
    private int estoque;
    
    public ProdutoTeste (String C) { // construtor
        this.codigo = C;
    }
    ...
    @Override
    public ProdutoTeste clone() {
       ProdutoTeste novo = new ProdutoTeste(this.codigo);
    ...
    @Override
    public int compareTo(ProdutoTeste p) {
